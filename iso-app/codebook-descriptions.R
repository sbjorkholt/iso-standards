...
participants_cb <- tibble("Variable" = c("country", "sdo", "year", "committee", "title", "membership", "standby", "impute", "sector",
                                         "One row represents: "),
                       "Description" = c("Country name", "Name of main standardization developing organization in the country",
                                         "Year of membership", "Number of the TC the country participates in",
                                         ...
                                         "Whether the TC was set to standby in the given year", "Whether memberships were imputed from the previous year",
                                         "The sector that ISO categorizes the TC into",
                                         "One country (national member body) in a given year"))

liaison_cb <- tibble("Variable" = c("acronym", "name", "year", "country", "category", "category_text", "description", "justification",
                                 "committee", "title", "type", "impute", "sector",
                                 "One row represents: "),
                  "Description" = c("Organization's acronym", "Name of organization", "Year of liaison", 
                                    "Country where the organization is located (fetched from address)",
                                    "Category of the organization of either industry, consultant and registrar, standards organization, government, research, NGO, financial institutions, media, intergovernmental organizations or other",
                                    "Category given in text", "Description of given category", "Justification from ChatGPT of why the given organization fits into the given category",
                                    "Number of the committee that the organization was in liaison with", "Name of the committee that the organization was in liaison with",
                                    "Type of liaison for the given organization", "Whether the membership in given committee was imputed using k-nearest neighbor methods",
                                    "The sector that ISO categorizes the TC into",
